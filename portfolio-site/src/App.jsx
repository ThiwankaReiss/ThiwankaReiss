...
const coreProjectsData = [
  ...
  },
  {
    ...
    image: '/img/Schematic_Diyakawa_electrical-wiring_system_2026-07-09.png',
    links: [
      {
        label: 'Code',
  ...
  },
  {
    ...
    image: '/img/Screenshot 2026-07-10 163447.png',
    links: [
      {
        label: 'Frontend',
      ...
      <main className="portfolio">
        <section className="hero-section">
          ...
          <div className="hero-photo-wrap">
            <img
              src="/img/WhatsApp Image 2026-07-10 at 15.24.30.jpeg"
              alt="Thiwanka Reiss"
